    ...
    */
    init(buttons: UIButton...) {
        ...
        for aButton in buttons {
            aButton.addTarget(self, action: #selector(pressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        }
    ...
    */
    func removeButton(aButton: UIButton) {
        ...
        if(iteratingButton != nil) {
            ...
            iteratingButton!.removeTarget(self, action: #selector(pressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
